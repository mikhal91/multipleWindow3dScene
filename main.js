...
{	
	...
	function render ()
	{
		...
		for (let i = 0; i < cubes.length; i++) {
			...
			updateComplexSphere(complexSphere, t, cubes);
		}
	...
	function updateComplexSphere(complexSphere, elapsedTime, allComplexSpheres) {
		...
		for (let otherSphere of allComplexSpheres) {
			if (otherSphere !== complexSphere) {
				let direction = new THREE.Vector3();
				direction.subVectors(otherSphere.position, complexSphere.position);
				...
				complexSphere.position.add(direction);
			}
		}
